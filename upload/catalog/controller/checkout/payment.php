...
class ControllerCheckoutPayment extends Controller {
    ...
    public function index() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && isset($this->request->post['voucher']) && $this->validateVoucher()) {
            ...
            $this->session->data['success'] = "Voucher Applied"; //$this->language->get('text_success');
            ...
            if (empty($this->request->post['voucher'])) {
                ...
                $this->session->data['error'] = $this->language->get('error_voucher');
            }
...
//        }
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && isset($this->request->post['payment_method']) && $this->validate()) {
