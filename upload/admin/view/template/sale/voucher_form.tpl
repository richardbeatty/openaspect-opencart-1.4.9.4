...
<div id="content">
  ...
  <div class="box">
    ...
    <div class="content">
      ...
      <a href="#" class="vouchertabs selected tabgeneral" ><?php echo $tab_general; ?></a>
        <?php if ($voucher_id) { ?>
        <a href="#" class="vouchertabs tabhistory" ><?php echo $tab_voucher_history; ?></a>
        <?php } ?>
      </div>
...
$('.vouchertabs').live('click', function() {
  
  $('#tabs a').removeClass('selected');
  $(this).addClass('selected');
  
  if($(this).hasClass("tabgeneral")){
    $('#tab-general').show();
    $('#tab-history').hide();
  }else{
    $('#tab-general').hide();
